...
namespace PassManager.Views
{
    public partial class ItemsPage : ContentPage
    {
        ...
        protected override void OnAppearing()
        {
            ...
            ItemsListView.ItemsSource = _viewModel.Items.OrderByDescending(o => o.PKey);
            MySBar.Text = "";
        ...
        {
            var searchBar = _viewModel.Items.Where(c => c.Text.ToLower().Contains(e.NewTextValue.ToLower()));
